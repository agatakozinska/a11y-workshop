...
- <a class="link" href="https://fandomdesignsystem.com/react-common/?path=/story/multiselect--default" target="_blank">Accessibility tab</a>
...
<a class="link" href="https://github.com/dequelabs/axe-core" target="_blank">Github page</a>

### How to Automate Accessibility Testing?

- Writing unit test with `jest/axe`
- Automation tests with axe-core - <a class="link" href="https://www.browserstack.com/guide/automate-accessibility-testing" target="_blank">BrowserStack Helps</a>
